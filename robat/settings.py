"""
Django settings for robat project.
...
SECRET_KEY = 'django-insecure-nw3==pfqo+g_tat)kyswuxak^nb5s0y)v00zj+x6ry-2t%6y*&'
...
WSGI_APPLICATION = 'robat.wsgi.application'
